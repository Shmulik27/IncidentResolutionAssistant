...
REQUESTS_TOTAL = Counter(
    "log_analyzer_requests_total", "Total requests to log analyzer", ["endpoint"]
)
ERRORS_TOTAL = Counter(
    "log_analyzer_errors_total", "Total errors in log analyzer", ["endpoint"]
)
ANOMALIES_TOTAL = Counter(
    "log_analyzer_anomalies_total", "Total anomalies detected", ["endpoint"]
)
    ...
    try:
        ...
        if not request.logs:
            ...
            return {
                "anomalies": [],
                "count": 0,
                "details": {"keyword": [], "frequency": [], "entity": [], "ml": []},
            }
